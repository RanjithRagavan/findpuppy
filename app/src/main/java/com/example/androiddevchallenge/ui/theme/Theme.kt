...
private val LightColorPalette = MyThemeColors(
    brand = Shadow5,
...
private val DarkColorPalette = MyThemeColors(
    brand = Shadow1,
...
fun ProvideMyThemeColors(
    ...
    CompositionLocalProvider(LocalMyThemeColors provides colorPalette, content = content)
}

private val LocalMyThemeColors = staticCompositionLocalOf<MyThemeColors> {
    error("No MyThemeColorsPalette provided")
}

/**
 * MyThemeColors custom Color Palette
 */
@Stable
class MyThemeColors(
